...
public abstract class AbstractCrudRepositoryGateway <E extends Serializable, T extends Serializable, ID extends Serializable> implements RepositoryGateway<E, ID> {
    protected abstract <A extends CrudRepository<T, ID>> A getRepository();
