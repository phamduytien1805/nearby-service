...
public class MultiResponse<T> extends Response {
    ...
    public static <T> MultiResponse<T> of(Collection<T> data, Object extraData) {
    ...
    public static <T> MultiResponse<T> of(Collection<T> data, Long total, Object extraData) {
        MultiResponse<T> response = MultiResponse.of(data, total);
        response.setExtraData(extraData);
        return response;
    }
}